...
const EditEvent = () => {
  ...
  const handleSubmit = async (e)=>{
    ...
    try {
      const response = await updateEvent(`/update/${prevEvent.id}` ,name, username, description, place, city, country, date, price);
      ...
      >
        <form onSubmit={handleSubmit} >
          ...
          >
            ...
            <CustomizedInput type="price" name="price" label="Price" value={prevEvent.price} onChange={(e) => onInputChange(e)}/>
