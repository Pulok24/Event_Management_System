...
const AttendeeRegister = () => {
  ...
  const handleSubmit = async (e)=>{
    ...
    try {
      ...
      const response = await addAttendee(prevEvent.id ,name, email, quantity);
    ...
    console.log(name + " and " + email + "and"+ quantity);
      ...
      >
        <form onSubmit={handleSubmit} >
          ...
          >
            ...
            <CustomizedInput type="number" name="quantity" label="Quantity"/>
            <Button
              type="submit"
              sx={{
                px: 2,
